...
ADMIN_IDS = [7958117532, 6003851152, 7938235371, 8183052860, 7833415667, 6620918854, 1954899834, 8327161310, 7488322832, 7812167808, 8430569586, 1596100597, 6187708693, 5911472543, 6076562401, 6076562401]


# Attendance windows (inclusive)
MORNING_START = dtime(10, 0, 0)
MORNING_END   = dtime(10, 40, 0)
...
# =============================
def main():
    BOT_TOKEN = "8513433639:AAHFrk6huOPDan4Zd_eGnkAEeGVlTVT-VkA" or "YOUR_BOT_TOKEN_HERE"
